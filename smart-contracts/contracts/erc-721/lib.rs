...
mod erc721 {
    ...
    impl Erc721 {
        /// Creates a new ERC-721 contract with the specified initial supply.
        #[ink(constructor)]
    ...
    mod tests {
        ...
        fn transfer_works() {
            ...
            // Check first transfer event related to ERC-721 instantiation.
            assert_transfer_event(
                &emitted_events[0],
                None,
                Some(AccountId::from([0x01; 32])),
